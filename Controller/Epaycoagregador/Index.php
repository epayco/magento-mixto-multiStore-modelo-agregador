...
class Index extends \Magento\Framework\App\Action\Action implements CsrfAwareActionInterface
{
    ...
    public function execute()
    {
        ...
        $urlRedirect = $this->scopeConfig->getValue('payment/epaycoagregador/payco_callback',$storeScope);
        ...
        if(isset($_GET['ref_payco'])){
            ...
            $p_cust_id_cliente = $this->scopeConfig->getValue('payment/epaycoagregador/payco_merchant',$storeScope);
            $p_key = $this->scopeConfig->getValue('payment/epaycoagregador/payco_key',$storeScope);

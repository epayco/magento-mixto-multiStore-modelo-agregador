<?php
	...
	namespace Pago\Paycoagregador\Controller\Paycoagregador;
	...
	class Index extends \Magento\Framework\App\Action\Action implements CsrfAwareActionInterface
	{
		...
		public function execute()
		{
			...
			if(isset($_GET['ref_payco'])){
				...
				$p_cust_id_cliente = $this->scopeConfig->getValue('payment/paycoagregador/paycoagregador_merchant',$storeScope);
				$p_key = $this->scopeConfig->getValue('payment/paycoagregador/paycoagregador_key',$storeScope);
